...
func init() {
	...
	// groupDescProvider is the schema descriptor for provider field.
	groupDescProvider := groupFields[6].Descriptor()
	// group.DefaultProvider holds the default value on creation for the provider field.
	group.DefaultProvider = groupDescProvider.Default.(string)
	// group.ProviderValidator is a validator for the "provider" field. It is called by the builders before save.
	group.ProviderValidator = groupDescProvider.Validators[0].(func(string) error)
