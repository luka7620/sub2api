...
type User struct {
	...
	// DailyCheckInDisabled holds the value of the "daily_check_in_disabled" field.
	DailyCheckInDisabled bool `json:"daily_check_in_disabled,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled, user.FieldDailyCheckInDisabled:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldDailyCheckInDisabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field daily_check_in_disabled", values[i])
			} else if value.Valid {
				_m.DailyCheckInDisabled = value.Bool
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("daily_check_in_disabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.DailyCheckInDisabled))
	builder.WriteByte(')')
