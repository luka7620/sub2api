...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cleanupRulesService := service.NewCleanupRulesService(client, settingService, apiKeyAuthCacheInvalidator, billingCacheService)
	settingHandler := admin.NewSettingHandler(settingService, emailService, turnstileService, opsService, paymentConfigService, paymentService, cleanupRulesService)
